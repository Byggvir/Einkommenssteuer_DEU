...
url <- 'https://de.wikipedia.org/wiki/Tarifgeschichte_der_Einkommensteuer_in_Deutschland'

Spalten <- c(
  'Zeitraum', 'E0', 'E1', 'E2', 'E3', 'S1', 'S2', 'S3', 'p1', 'sg1', 'p2', 'sg2', 'sg3', 'sg4', 'Quelle'
)
ESt = as.data.table( htmltab( url 
                              , which = 8
                              , bodyFun = bFun 
                              , header = 1:3
                              , colNames = Spalten
